 ...
 */
final class Version20240801184553 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D649B4C7A8CA FOREIGN KEY (user_infos_id) REFERENCES user_infos (id) ON UPDATE NO ACTION ON DELETE CASCADE');
    }
}
